...
.sms-panel { width: 380px; overflow: hidden; border-radius: 52px 52px 52px 52px; flex-shrink: 0; }
...
.arrow-wrap { display: flex; align-items: center; justify-content: center; width: 64px; margin-top: 150px; flex-shrink: 0; }
</style>
</head>
<body>
<div class="wrap">
